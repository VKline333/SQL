...
INSERT Person.Person VALUES (35532888963,'Ali','Tekin');-- Tüm sütunlara deðer atanacaðý varsayýlmýþtýr.
...
Alter table Person.Person add constraint FK_PersonID_check Check (SSN between 1000000000 and 99999999999)
